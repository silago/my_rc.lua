...
-- 
tagnames = { "★ WEB", ">_ TERM", "⚒ EDTIT", "❖ FILES","♻ DB", "♞ IM", "♬ FUN" }
tags = {}
for s = 1, screen.count() do
    tags[s] = {}
    for t = 1, #tagnames do
        -- tags[s] = {}
        tags[s][t] = tag({ name = tagnames[t] })
	tags[s][t].layout = layouts[2]
        tags[s][t].screen = s
    end
...
-- mygmailimg.image = image("/home/aovchinnikov/.config/awesome/gmail.png")
-- 
